...
const parser=fs.readFileSync(new URL('../src/lib/epubParser.js',import.meta.url),'utf8');
assert.match(parser,/buildEpubRuntime/);assert.match(parser,/buildEpubReaderModel/);
assert.doesNotMatch(parser,/rawPages|extractPageWithOrdering|fillImageDataUris|buildSectionsFromToc|activateReaderModel|qualified-shadow|shadow-compare/);
assert.match(parser,/legacyParserExecuted:false/);
