...
assert.equal(reader.includes('<DictionaryManagementPanel'), false, 'Dictionary management must remain outside the Reader shell');
...
console.log('Phase 15.2 Reader shell decomposition and Settings boundary tests passed');
