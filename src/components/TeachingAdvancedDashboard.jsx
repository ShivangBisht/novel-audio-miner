...
const TOOLS = [
  ...
  ['quality', 'Quality and corpus', 'Review and approve individual evidence.'],
  ['governance', 'Corpus governance', 'Check coverage, provenance leakage, and tuning readiness.'],
...
export default function TeachingAdvancedDashboard({ records = [], onClose }) {
  ...
  return <section className="teaching-advanced-dashboard" data-testid="teaching-advanced-dashboard">
    ...
    {tool && <div className="teaching-tool-workspace">
      ...
      {tool === 'governance' && <TeachingCorpusGovernancePanel />}
