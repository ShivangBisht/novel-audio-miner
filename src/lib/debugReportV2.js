...
export function buildDebugReportV2({
  ...
  presentationSpans = [], learning = {}, selection = {}, mining = {}, statusDomains = {}, contractDiagnostics = null, persistenceDiagnostics = null,
  ...
  const report = {
    ...
    persistence: clone(persistenceDiagnostics),
    ...
    epub: {
      ...
      authoritativeParser: clone(book?.epubRuntimeDiagnostics || null),
      readerModelQualification: clone(book?.readerModelQualification || null)
    }
  };
  return report;
}
