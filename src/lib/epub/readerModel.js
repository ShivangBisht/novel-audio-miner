...
export async function buildEpubReaderModel({runtime,zip}={}){const contextualScenePlanning=buildContextualSceneDiagnostics({runtime});const gate=qualifyEpubRuntime(runtime);if(!gate.valid){
