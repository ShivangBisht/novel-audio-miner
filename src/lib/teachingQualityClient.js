...
export const setRecordQuality=(id,qualityStatus,reviewer,qualityNote)=>request(`/teaching-quality/${encodeURIComponent(id)}`,{method:'PUT',body:JSON.stringify({qualityStatus,reviewer:reviewer||null,qualityNote:qualityNote||null})});
